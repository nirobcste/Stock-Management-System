...
namespace StockManagmentApp
{
    public partial class SearchandViewItemUi : Form
    {
        ...
        private void showDataGridView_RowPrePaint(object sender, DataGridViewRowPrePaintEventArgs e)
        {
            this.showDataGridView.Rows[e.RowIndex].Cells["serialNo"].Value = (e.RowIndex + 1).ToString();
        }
