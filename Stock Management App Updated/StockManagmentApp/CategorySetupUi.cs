...
namespace StockManagmentApp
{
    public partial class CategorySetupUi : Form
    {
        ...
        private void categoryShowDataGridView_RowPostPaint(object sender, DataGridViewRowPostPaintEventArgs e)
        {
            this.categoryShowDataGridView.Rows[e.RowIndex].Cells["serialNo"].Value = ((e.RowIndex+1).ToString());
        }
    }
}
